...

{
  ...
  services.dnsmasq.extraConfig = let
    hosts-blocklists = pkgs.fetchFromGitHub {
      owner = "notracking";
      repo = "hosts-blocklists";
      rev = "d0c6b7c215f9bec481929e2372bad5ad70e4dc64";
      sha256 = "1mdc8qcdb15xkk609gln64398hq6jign0bmwhyzy6nd9wx3klavw";
    };
  in ''
    domain-needed
    bogus-priv
    ...
    conf-file=${hosts-blocklists}/dnsmasq/dnsmasq.blacklist.txt
  '';
